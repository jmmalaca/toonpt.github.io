...
function firstCommands(terminal, command) {
    if (command.match("^whoami$")) {
        ...
        terminal.echo("[" + green_text + "ϟ] [" + green_text + "Citadel - Valuation Metrics], href=\"" + projectsLinks[6] + "\" @ MarsBased");
        terminal.echo("[" + green_text + "ϟ] [" + green_text + "Infopraca.pl], href=\"" + projectsLinks[5] + "\" @ MarsBased");
